...
const magic1 = [{ name: "Ice", damage: 10, mpDrain: 20 }, { name: "Bolt", damage: 15, mpDrain: 30 }];
const magic2 = [{ name: "Fire", damage: 40, mpDrain: 35 }];
const magic3 = [{ name: "Restore", damage: -20, mpDrain: 20 }];

const hero1 = { name: "Wizard",    el: heroSpriteEls[0], nameEl: heroNameEls[0], maxHp: 1500, hp: 1250, mp: 75,  wait: 10,  magic: magic1, items: ["Potion"] };
const hero2 = { name: "Firefox",   el: heroSpriteEls[1], nameEl: heroNameEls[1], maxHp: 600,  hp: 475,  mp: 200, wait: 100, magic: magic2, items: [] };
const hero3 = { name: "Warrior",   el: heroSpriteEls[2], nameEl: heroNameEls[2], maxHp: 250,  hp: 750,  mp: 120, wait: 0,   magic: magic3, items: ["Potion", "Potion"] };
